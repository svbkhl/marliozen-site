...
export const events: Event[] = [
  {
    slug: "champions-d-aix-2026",
    title: "Champion's d'Aix III",
    shortTitle: "Champion's d'Aix III",
    category: "sport",
    date: "2026-06-07",
    dateDisplay: "Dimanche 7 juin 2026",
    time: "09h00",
    location: "Stade Garibaldi",
    address: "Stade Garibaldi, Aix-les-Bains",
    description:
      "3e édition du tournoi de football inter-quartier intergénérationnel. Venez jouer, encourager et partager un repas convivial au stade.",
    longDescription: `Le tournoi Champion's d'Aix est l'événement sportif phare de La Marlio'Zen. Pour cette 3e édition, des équipes de tous les quartiers d'Aix-les-Bains se retrouvent au Stade Garibaldi pour disputer un tournoi de football convivial et intergénérationnel.
...
Au programme : matchs de football dès 9h, animation jeunesse, buvette et repas partagé offert par l'association. Familles et supporters sont les bienvenus !`,
  ...
  {
    slug: "cinema-plein-air-2026",
    title: "Cinéma plein air & repas partagé",
    shortTitle: "Ciné plein air",
    category: "culture",
    date: "2026-07-17",
    dateDisplay: "Vendredi 17 juillet 2026",
    time: "19h30",
...
Cette soirée est ouverte à tous, petits et grands. Apportez votre chaise pliante ou votre plaid, un plat à partager, et venez vivre un moment de convivialité unique au cœur du quartier.`,
  ...
  {
    slug: "fete-cuisines-du-monde-2026",
    title: "Fête des cuisines du monde",
    shortTitle: "Cuisines du monde",
    category: "festif",
    date: "2026-09-19",
    dateDisplay: "Samedi 19 septembre 2026",
    time: "12h00",
...
Au-delà des saveurs, c'est un moment de partage, de rencontres et de mixité sociale que La Marlio'Zen chérit particulièrement. Venez les mains pleines et repartez le cœur plein !`,
  ...
  {
    slug: "atelier-acces-droits-juin-2026",
    title: "Atelier Accès aux droits — Juin 2026",
    shortTitle: "Accès aux droits",
    category: "solidarite",
    date: "2026-06-04",
    dateDisplay: "Jeudi 4 juin 2026",
    time: "14h00",
...
Accueil sans rendez-vous de 14h à 17h. Permanence gratuite et confidentielle.`,
  ...
  {
    slug: "sortie-randonnee-printemps-2026",
    title: "Randonnée printanière en famille",
    shortTitle: "Randonnée famille",
    category: "famille",
    date: "2026-04-18",
    dateDisplay: "Samedi 18 avril 2026",
    time: "09h00",
